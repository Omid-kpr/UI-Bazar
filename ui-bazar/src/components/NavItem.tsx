                ...
                <div className={cn("absolute inset-x-0 top-full text-sm text-muted-foreground",
                    ...
                    <div className="relative bg-white">
                        <div className="mx-auto max-w-7xl px-8">
                            <div className="grid grid-cols-4 gap-x-8 gap-y-10 pt-12 pb-6">
                                    ...
                                    {category.featured.map((item) => (
                                        <div key={item.name} className="group relative text-base sm:text-sm">
                                            ...
                                            <div className="flex justify-center">
                                                <Link href={item.href} className="mt-6 block font-bold text-lg text-blue-900 ">{item.name}</Link>
                                            </div>
                                            <p className="flex justify-center mt-1">خرید کنید</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
